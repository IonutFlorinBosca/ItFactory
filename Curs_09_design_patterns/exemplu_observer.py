"""
Observer este un sablon de proiectare comportamental care te lasa
sa definesti un mecanism de subscriere prin care mai multe obiecte
pot fi notificate despre evenimente care se intampla in obiectele
pe care le observa
"""
...
class Person(Observer):
    ...
    def update(self, observable):
        if observable._istoric[-1].content.startswith(self.name):
