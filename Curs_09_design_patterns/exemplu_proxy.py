"""
Proxy este un sablon structural care lasa sa dai un substitut pentru
un alt obiect. Un obiect proxy controleaza accesul catre obiectul original,
lasand doar anumite operatii sa fie efectuate sau sa adauge pasi extra
...
Dezavantaje:
    -> codul devine mai complicat deoarece este necesara introducerea mai multor
    clase
    -> rezultatul obtinut de la obiectul real poate fi intarziat
"""
